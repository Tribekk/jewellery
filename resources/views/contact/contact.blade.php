...
<section class="contacts black_background">
    <div class="container-lg">
        <h1>Контакты</h1>
        <div class="intro">
            <p>Добро пожаловать на страницу контактов компании ООО ЮВЕЛИРНАЯ КОМПАНИЯ "КАРДУС КАРИН". Мы гордимся своим
        ...
        <div class="contact-section">
            ...
            <div class="contact-info">
                ...
                <div class="info-block">
                    <h3>Email</h3>
                    <p><a href="mailto:info@carduuscarin.ru">info@carduuscarin.ru</a></p>
        ...
        <div class="contact-section">
            ...
            <div class="bank-details">
                <table>
                    ...
                    <tr>
                        <th><p>Р/c</p></th>
                        <td><p>40702 810 8 4600 0024913</p></td>
                    </tr>
                    <tr>
                        <th><p>К/c</p></th>
                        <td><p>30101 810 6 0000 0000601</p></td>
                    </tr>
                    <tr>
                        <th><p>Банк</p></th>
                        <td><p>ОРЕНБУРГСКОЕ ОТДЕЛЕНИЕ N8623 ПАО СБЕРБАНК</p></td>
                    </tr>
                    <tr>
                        <th><p>Адрес банка</p></th>
                        <td><p>г. Оренбург, ул. Володарского, д.16</p></td>
                    </tr>
                </table>
            </div>
        </div>
