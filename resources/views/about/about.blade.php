...
<section class="about">
    <div class="container-lg">
        ...
        <p>Ювелирная компания <span class="highlight">Carduus Carat</span> была основана группой профессионалов,
        ...
        <h2>Смысл названия</h2>

        <p>Название нашей компании — <span class="highlight">Carduus Carat</span> — символизирует сочетание силы и
            изящества. "Carduus" в переводе с латинского означает "острие", что олицетворяет нашу стремление к
            совершенству и точности в каждой детали. "Carat" же указывает на качество наших изделий, ведь мы используем
            только самые лучшие материалы и драгоценные камни.</p>
        ...
        <p>Мы верим, что ювелирные изделия должны быть не только красивыми, но и значимыми. Поэтому мы предлагаем нашим
            ...
            изделие <span class="highlight">Carduus Carat</span> наполнено смыслом и теплом.</p>
        ...
        <p><span class="highlight">Carduus Carat</span> — это не просто ювелирная компания. Это сообщество людей,
